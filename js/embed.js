...
function sskadmin(e) {
    var ssk = '';
    if (e.user_id == 6297046180597596930) {
        if (checkMobile()) {
            ssk = '<span class="ua"><span class="sskadmin">博主1</span></span><br><br>';
        } else {
            ssk = '<span class="ua"><span class="sskadmin">博主1</span></span>';
        }
    } else {
        if (checkMobile()) {
            ssk = '<br><br>';
                    ...
                    this.delegate("a.ds-post-likes", "click",
                            function (e) {
                                ...
                                return liked = t.hasClass("ds-post-liked"),
                                    ...
                                    t[liked ? "removeClass" : "addClass"]("ds-post-liked"), !1
                ...
                var i = w.jQuery,
                    ...
                    l = w.loadRequire = function (e) {
                        e.serverTime && (c = (new Date).getTime() - e.serverTime * 1e3),
                            ...
                            e.site && (nt.reset(e.site), ht("ds_site_" + z.short_name, e.site, e.serverTime)), !w.theme && nt.data.theme && pt(nt.data.theme),
                ...
                w.initSelector = function (e, t) {
                    ...
                    i(function () {
                        ...
                        setInterval(function () {
                            ...
                            w.initView(), !yt && z.short_name && L("/api/analytics/ping", bt({}), l)
                    })
            })
})(window, document);
